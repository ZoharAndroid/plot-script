...
# wo
wo_l1_data=[10.499, 18.000, 13.421]
wo_l2_data=[19.271, 35.318, 32.889]
wo_l3_data=[1.421, 0.722, 0.132]
# w
w_l1_data=[10.499, 18.000, 13.421]
w_l2_data=[19.271, 35.318, 32.889]
w_l3_data=[56.732, 54.439, 42.556]
...
bar1 = Plot.plot_bar(np.arange(1, 4, 1), wo_l1_data, color=Color.dark_color[3], bar_width=0.3)
bar2 = Plot.plot_bar(np.arange(1, 4, 1), wo_l2_data, color=Color.dark_color[4], bottom=wo_l1_data, bar_width=0.3)
bar3 = Plot.plot_bar(np.arange(1, 4, 1), wo_l3_data, color='red', bar_width=0.3,
...
bar1 = Plot.plot_bar(np.arange(1, 4, 1), w_l1_data, color=Color.dark_color[3], bar_width=0.3)
bar2 = Plot.plot_bar(np.arange(1, 4, 1), w_l2_data, color=Color.dark_color[4], bottom=w_l1_data, bar_width=0.3)
bar3 = Plot.plot_bar(np.arange(1, 4, 1), w_l3_data, color='red', bar_width=0.3,
...
Save.save_to_pdf('exp-performance-2'+'-'+platform)
